    ...
    arrangeQuestion: () => {
        ...
        if (quizData.skill_code == 'FRAC_ADD_SUB') {            
            for (let i = 0; i < questionArray.length; i++) {
                ...
                content += `<div class="row col-9 justify-content-center align-items-center text-center m-auto mb-5 question"><div class="small col-md-2">Q${i + 1}</div>`;
                    ...
                    if (i < numOfEasy + numOfMedium) {
                        if (l % 2 == 0 ) {
                            ...
                            content += `<div class="col">
                                            <div>${questionArray[i][1][index]}</div>
                                        </div>`
                        }
                    }
