...
$(document).on("click", ".click", function () {
    ...
    if (id == "beginBtn") {
        ...
        $("input").each(function () {
            if (
                $.trim($(this).val()) == "" &&
                quizData.topic_name != "Rational Numbers"&&quizData.topic_name!="Algebra"
            ) {
                id = this.id;
                isFill = false;
        ...
        if ((isFill && isNumber) || countdown < 1) {
            ...
            let time =
                Math.floor(timeTaken / 60) +"." +(timeTaken - Math.floor(timeTaken / 60) * 60);
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            let content = `
                <div class="row p-0">
                    ...
                    <ul class="dropdown-menu ${name} levelNo" aria-labelledby="dropdownMenuLink" style="width:${$(
                "#opdownMenuLink"
            ).width()}">`;
            var topics = "";
...
const decimal={
    ...
    generateQuestion: (quizData) => {
        ...
        for(var i=0;i<numOfEasy;i++){
            const randomDecimal=parseFloat(((Math.random() * 99) + 0).toFixed(7))
        ...
        for(var i=0;i<numOfHard;i++){
            ...
            for(var i=0;i<numOfEasy;i++){
                const randomDecimal1=parseFloat(((Math.random() * 20) + 0).toFixed(1))
                const randomDecimal2=parseFloat(((Math.random() * 20) + 0).toFixed(1))
            ...
            for(var i=0;i<numOfMedium;i++){
                const randomDecimal1=parseFloat(((Math.random() * 50) + 0).toFixed(2))
                const randomDecimal2=parseFloat(((Math.random() * 50) + 0).toFixed(2))
            ...
            //difficult_values
            for(var i=0;i<numOfHard;i++){
                const randomDecimal1=parseFloat(((Math.random() * 99) + 0).toFixed(2))
                const randomDecimal2=parseFloat(((Math.random() * 99) + 0).toFixed(2))
                let bigNum=0;
                let smallNum=0;
            ...
            for(var i=0;i<numOfEasy;i++){
                const randomDecimal1=parseFloat(((Math.random() * 20) + 0).toFixed(1))
                const randomDecimal2=parseFloat((Math.floor(Math.random() * 20) + 0).toFixed(1))
                const ansDecimal=(randomDecimal1*randomDecimal2).toFixed(1)
                let decimalQn={qnA:randomDecimal1,qnB:randomDecimal2,ans:ansDecimal,type:"easy"}
                questionArray.push(decimalQn)
            }
            ...
            for(var i=0;i<numOfMedium;i++){
                const randomDecimal1=parseFloat(((Math.random() * 50) + 0).toFixed(2))
                const randomDecimal2=parseFloat((Math.floor(Math.random() * 50) + 0).toFixed(2))
                const ansDecimal=(randomDecimal1*randomDecimal2).toFixed(2)
                let decimalQn={qnA:randomDecimal1,qnB:randomDecimal2,ans:ansDecimal,type:"medium"}
                questionArray.push(decimalQn)
            }
            for(var i=0;i<numOfHard;i++){
                const randomDecimal1=parseFloat(((Math.random() * 99) + 0).toFixed(3))
                const randomDecimal2=parseFloat((Math.floor(Math.random() * 99) + 0).toFixed(3))
    ...
    gcd:(number1,number2)=>{
     ...
     generateQuestion: (quizData) => {
         ...
         for(var i=0;i<numOfEasy;i++){
             ...
             const firstNumber=parseFloat(((Math.random() * 20) + 1).toFixed(0))
             const secondNumber=parseFloat(((Math.random() * 20) + 1).toFixed(0))
         ...
         for(var i=0;i<numOfMedium;i++){
             ...
             alphabet += possible.charAt(Math.floor(Math.random() * possible.length));
              ...
              const firstNumber=parseFloat(((Math.random() * 20) + 1).toFixed(0))
             const secondNumber=parseFloat(((Math.random() * 20) + 1).toFixed(0))
             const thirdNumber=parseFloat(((Math.random() * 20) + 1).toFixed(0))
         ...
         for(var i=0;i<numOfHard;i++){
             ...
             for(var i=0;i<numOfMedium;i++){
                 ...
                 let firstNumberqn=Math.floor((Math.random() * ((9*2)+1)) + (-9));
                 let secondNumberqn=Math.floor((Math.random() * ((9*2)+1)) + (-9));
                 let firstpower=Math.floor((Math.random() * ((9*2)+1)) + (-9));
                 let secondpower=Math.floor((Math.random() * ((9*2)+1)) + (-9));
