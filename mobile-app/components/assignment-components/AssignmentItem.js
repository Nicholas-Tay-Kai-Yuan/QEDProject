...
const AssignmentBox = ({post, assignmentStatus}) => {
  ...
  return (
    <TouchableOpacity style={styles.view} onPress={assignmentStatus == "Completed" ? () => navigate("/viewpastquiz", {state: {quizId: post.completed_quiz}}) : () => console.log("not completed") }>
      <View>
