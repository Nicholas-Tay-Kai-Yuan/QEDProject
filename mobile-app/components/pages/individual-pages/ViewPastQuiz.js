                ...
                {answers != undefined ?
                    answers.questions.map((questions, index) => (
                        <View style={styles.tableHeaderTotal}>
                            ...
                            <View style={styles.tableContent}>{answers.topic_name == "Fractions" ? formatToFraction(questions.question) : answers.topic_name == "Rational Numbers" ? formatQuestion(questions.question) : <Text style={styles.tableContentTotal}>{questions.question}</Text>}</View>
                            <View style={styles.tableContent}>{answers.topic_name == "Fractions" ? formatToFraction(questions.answer) : answers.topic_name == "Rational Numbers" ? formatQuestion(questions.answer) : <Text style={styles.tableContentTotal}>{questions.answer}</Text>}</View>
                            <View style={styles.tableContent}>{answers.topic_name == "Fractions" ? formatToFraction(questions.correct_answer) : answers.topic_name == "Rational Numbers" ? formatQuestion(questions.correct_answer) : <Text style={styles.tableContentTotal}>{questions.correct_answer}</Text>}</View>
